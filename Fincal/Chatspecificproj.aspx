<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Chatspecificproj.aspx.cs" Inherits="Fincal.Chatspecific" %>
                ...
                <div id="Invlaidproject" runat="server" class="row red-text text-lighten-2">
                  ...
                  <div class="row">
                    <div class="input-field col s12 m12 l12 ">
                        ...
                        <textarea  style="height: 6rem; " readonly id="txtmsg" class="materialize-textarea" runat="server"></textarea>
