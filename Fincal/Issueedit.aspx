<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Issueedit.aspx.cs" Inherits="Fincal.Issueedit" %>
    ...
    <div class="row" id="projecteditdiv" runat="server">
        <div class="col s12 m10 l8 push-m1 push-l2">
                 ...
                 <div class="row">
                    <div class="input-field col  s12 m12 l12">
                        ...
                        <label for="Currentmembers">Current Members</label>
                             <blockquote>Remove members from the issue.</blockquote>
                    </div>
              ...
              <a href="Projects.aspx" class="waves-effect waves-light btn orange"><i class="material-icons left">cancel</i>Cancel</a>
                          ...
                          <div class="modal" id="AcceptUpdate">
                            <div class="modal-content">
                              ...
                              <p>Are you sure you want to edit this issue?</p>
                            </div>
                            <div class="modal-footer">
                              <a href="#" runat="server" OnServerClick="btnissedit_ServerClick" class="modal-action modal-close waves-effect waves-green btn-flat green-text">Yes I'm Sure</a>
         ...
         <div class="modal" id="AcceptDelete">
                            ...
                            <div class="modal-footer">
                              <a href="#" runat="server" OnServerClick="btnissdelete_ServerClick" class="modal-action modal-close waves-effect waves-green btn-flat green-text">Yes I'm Sure</a>
                              <a href="#" class="modal-action modal-close waves-effect waves-orange btn-flat orange-text lighten-2">Cancel</a>
                            </div>
                          </div>
    </div>
