...
namespace Fincal
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void RegisterUser_ServerClick(object sender, EventArgs e)
        {
            ...
            if ((txtFirstName.Value.Equals("")) || (txtLastName.Value.Equals("")) || (txtEmail.Value.Equals("")) || (txtConfirmEmail.Value.Equals("")) || (txtDoB.Value.Equals("")) || (txtUsername.Value.Equals("")) || (txtPassword.Value.Equals("")) || (txtConfirmPassword.Value.Equals("")))
            {
                blnRegister = false;
            ...
            if (blnRegister)
            {
                ...
                service.insertUser(txtUsername.Value, Security.HashPassword(txtPassword.Value), txtFirstName.Value, txtLastName.Value, txtEmail.Value, Convert.ToDateTime(txtDoB.Value));
